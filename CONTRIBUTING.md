...
```bash
$ git clone git@github.com:username/ecma402.git
```

This will clone your fork to your current path in a directory named `ecma402`.
...
```bash
$ cd ecma402
$ git remote add upstream git@github.com:ibm-dojo/ecma402.git
$ git fetch upstream
```
