...
define({
	...
	// capabilities can be overridden by any of the
	// specified browser environments in the `environments` array below as well.
	// See
	// https://code.google.com/p/selenium/wiki/DesiredCapabilities for standard
	// Selenium capabilities and
	// https://saucelabs.com/docs/additional-config#desired-capabilities for
	// Sauce Labs capabilities.
	// Note that the `build` capability will be filled in with the current
	// commit ID from the Travis CI environment
	// automatically
	capabilities : {
	...
	// must be strings if used with Sauce
	// OnDemand. Options that will be permutated are browserName, version,
	// platform, and platformVersion; any other
	...
	// Labs, keep your username and password
	// in the SAUCE_USERNAME and SAUCE_ACCESS_KEY environment variables unless
	// you are sure you will NEVER be
