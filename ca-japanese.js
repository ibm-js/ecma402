define(
	...
	var ca_japanese = {};
	ca_japanese.ToLocalTime = function (date, timeZone) {
		var result = new Record();
		var dt = new Date(date);
		result.set("weekday", timeZone == "UTC" ? dt.getUTCDay() : dt.getDay());
		/* Current highest era number in Japanese calendar is 235 - Will need to bump this up if Japan gets a new emperor!!! */
